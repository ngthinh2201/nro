...
public class NPoint {
    ...
    public boolean khangTDHS; // Cải trang THOR
    ...
    private void setPointWhenWearClothes() {
        ...
        if (this.player.isPl()) {
            if (Manager.listHeadSanta.contains(this.player.head)) {
                tlHp.add(2);
                tlMp.add(2);
                tlDame.add(2);
            }
    ...
    private void setHpHoi() {
        this.hpHoi = Util.ndt(this.hpMax / 100);
    ...
    private void setMpHoi() {
        this.mpHoi = Util.ndt(this.mpMax / 100);
    ...
    private void setDame() {
        ...
        if (this.player.itemTime != null && this.player.itemTime.isUseCuongNo2) {
            this.dame += ((long) this.dame * 120 / 100);
        }
        //giảm dame
    ...
    public long calSucManhTiemNang(long tiemNang) {
        if (power < getPowerLimit()) {
            ...
            ///new
            if (this.player.itemTime != null && this.player.itemTime.isUsex2tnsm) {
                // Cộng x2 tiềm năng sức mạnh cho sư phụ và pet (nếu có)
                tiemNang += tn * 2;
            }
