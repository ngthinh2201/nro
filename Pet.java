    ...
    public void update() {
        try {
            ...
            if (justRevived && this.zone == master.zone) {
                Service.gI().chatJustForMe(master, this, "Sư phụ ơi, coăn đây nè!");
                justRevived = false;
            }
                ...
                case GOHOME:
                    if (this.zone != null && (this.zone.map.mapId == 21 || this.zone.map.mapId == 22 || this.zone.map.mapId == 23)) {
                        if (System.currentTimeMillis() - lastTimeMoveAtHome <= 5000) {
                            ...
                            Service.gI().chatJustForMe(master, this, "H2SO4 -> Uống ngọt lắm sư phụ ạ!");
            ...
            switch (this.playerSkill.skillSelect.template.id) {
                ...
                case Skill.KAIOKEN:
                    if (SkillService.gI().canUseSkillWithCooldown(this) && SkillService.gI().canUseSkillWithMana(this)) {
                        ...
                        SkillService.gI().useSkill(this, playerAttack, mobAttack, null);
                         Service.gI().chatJustForMe(master, this, "Muda!Muda!Muda!Muda!");
...
//    }
  ...
  public short getFlagBag() {
        if (this.effectSkill != null && this.effectSkill.isAnThan) {
            return -1;
        }
...
//    ========================================================
    ...
    public void transform() {
        ...
        if (this.typePet == 2) {
            this.isTransform = !this.isTransform;
            Service.gI().Send_Caitrang(this);
            Service.gI().chat(this, "Tao là bố của Mày\n Mày là coăn tao");
        }
    }
